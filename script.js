...
function modal(button) {
    ...
    let abaspedagogicasModal = modal.querySelector("#abaspedagogicasModal");
    let advertenciasModal = modal.querySelector("#advertenciasModal");
    let btnExcluirAluno = modal.querySelector("#btnExcluirAluno");

    if (!matriculaModal || !nomeModal || !notaModal || !frequenciaModal || !abaspedagogicasModal || !advertenciasModal || !btnExcluirAluno) {
    ...
    abaspedagogicasModal.innerHTML = aluno.abaspedagogicas;
    advertenciasModal.innerHTML = aluno.advertencias;
...
function cadastrarAluno() {
    ...
    let abaspedagogicas = document.getElementById("abaspedagogicas").value;
    let advertencias = document.getElementById("advertencias").value;
    ...
    let novoAluno = {
        ...
        abaspedagogicas: abaspedagogicas,
